 ...
 private static final byte BITCOIN_SEED[] = {
  'B', 'i', 't', 'c', 'o', 'i', 'n', ' ', 's', 'e', 'e', 'd'
    ...
    private static void testBip32Derive(byte[] apduBuffer, boolean hardened) {
     ...
     try {
      if (hardened) {
       boolean isZero = true; byte i; if ((DERIVATION_HARDENED[0] & (byte)0x80) == 0) { proprietaryAPI.getUncompressedPublicPoint(PRIVATE_SEED, (short)0, apduBuffer, (short)0); apduBuffer[(short)0] = ((apduBuffer[(short)((short)0 + 64)] & 1) != 0 ? (byte)0x03 : (byte)0x02); } else { apduBuffer[(short)0] = 0; Util.arrayCopyNonAtomic(PRIVATE_SEED, (short)0, apduBuffer, (short)((short)0 + 1), (short)32); } Util.arrayCopyNonAtomic(DERIVATION_HARDENED, (short)0, apduBuffer, (short)((short)0 + 33), (short)4); if ((nativeHmacSha512 != null) && (hmacKey != null)) { hmacKey.setKey(CHAIN_SEED, (short)0, (short)32); if ((proprietaryAPI != null) && (proprietaryAPI.hasHmacSHA512())) { proprietaryAPI.hmacSHA512(hmacKey, apduBuffer, (short)0, (short)37, apduBuffer, (short)0); } else { nativeHmacSha512.init(hmacKey, Signature.MODE_SIGN); nativeHmacSha512.sign(apduBuffer, (short)0, (short)37, apduBuffer, (short)0); } } else { HmacSha512.hmac(CHAIN_SEED, (short)0, (short)32, apduBuffer, (short)0, (short)37, apduBuffer, (short)0, apduBuffer, (short)65); } if (MathMod256.ucmp(apduBuffer, (short)0, Secp256k1.SECP256K1_R, (short)0) >= 0) { ISOException.throwIt(ISO7816.SW_WRONG_DATA); } MathMod256.addm(buffer, (short)0, apduBuffer, (short)0, PRIVATE_SEED, (short)0, Secp256k1.SECP256K1_R, (short)0); for (i=0; i<(byte)32; i++) { if (buffer[(short)((short)0 + i)] != 0) { isZero = false; break; } } if (isZero) { ISOException.throwIt(ISO7816.SW_WRONG_DATA); } Util.arrayCopyNonAtomic(apduBuffer, (short)((short)0 + 32), buffer, (short)((short)0 + 32), (short)32);;
       ...
       boolean isZero = true; byte i; if ((DERIVATION_NON_HARDENED[0] & (byte)0x80) == 0) { proprietaryAPI.getUncompressedPublicPoint(PRIVATE_SEED, (short)0, apduBuffer, (short)0); apduBuffer[(short)0] = ((apduBuffer[(short)((short)0 + 64)] & 1) != 0 ? (byte)0x03 : (byte)0x02); } else { apduBuffer[(short)0] = 0; Util.arrayCopyNonAtomic(PRIVATE_SEED, (short)0, apduBuffer, (short)((short)0 + 1), (short)32); } Util.arrayCopyNonAtomic(DERIVATION_NON_HARDENED, (short)0, apduBuffer, (short)((short)0 + 33), (short)4); if ((nativeHmacSha512 != null) && (hmacKey != null)) { hmacKey.setKey(CHAIN_SEED, (short)0, (short)32); if ((proprietaryAPI != null) && (proprietaryAPI.hasHmacSHA512())) { proprietaryAPI.hmacSHA512(hmacKey, apduBuffer, (short)0, (short)37, apduBuffer, (short)0); } else { nativeHmacSha512.init(hmacKey, Signature.MODE_SIGN); nativeHmacSha512.sign(apduBuffer, (short)0, (short)37, apduBuffer, (short)0); } } else { HmacSha512.hmac(CHAIN_SEED, (short)0, (short)32, apduBuffer, (short)0, (short)37, apduBuffer, (short)0, apduBuffer, (short)65); } if (MathMod256.ucmp(apduBuffer, (short)0, Secp256k1.SECP256K1_R, (short)0) >= 0) { ISOException.throwIt(ISO7816.SW_WRONG_DATA); } MathMod256.addm(buffer, (short)0, apduBuffer, (short)0, PRIVATE_SEED, (short)0, Secp256k1.SECP256K1_R, (short)0); for (i=0; i<(byte)32; i++) { if (buffer[(short)((short)0 + i)] != 0) { isZero = false; break; } } if (isZero) { ISOException.throwIt(ISO7816.SW_WRONG_DATA); } Util.arrayCopyNonAtomic(apduBuffer, (short)((short)0 + 32), buffer, (short)((short)0 + 32), (short)32);;
